...
function printParameters() {
	...
	console.log(`Length: ${arguments.length}`); // Length of the array
	console.log(arguments[0]); // We can only pick individuals values by their index
}
printParameters(2, 3, "word");

/*
	- The spread syntax (...) allows us to deconstruct the array. Useful for duplicating the values of an array too
*/
